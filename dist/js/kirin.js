...
/* harmony import */ var _easing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./easing */ "./src/js/animations/easing.js");
...
var Animation = function Animation(node, curStyleProp) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              name = anim.name;
              _context.t0 = name;
              _context.next = _context.t0 === 'delay' ? 8 : _context.t0 === 'hide' ? 11 : _context.t0 === 'show' ? 11 : _context.t0 === 'hideToggle' ? 11 : _context.t0 === 'fadeIn' ? 14 : _context.t0 === 'fadeOut' ? 14 : _context.t0 === 'fadeToggle' ? 14 : _context.t0 === 'fadeTo' ? 14 : _context.t0 === 'slideUp' ? 17 : _context.t0 === 'slideDown' ? 17 : _context.t0 === 'slideToggle' ? 17 : _context.t0 === 'animate' ? 20 : 23;
              break;
  ...
  var fadeAnimation = function fadeAnimation(anim) {
    return new Promise(function (resolve, reject) {
      var fromOpacity, toOpacity, diff;
      var name = anim.name,
          display = anim.display,
      ...
      var id = setInterval(function () {
        time += 10;
        node.style.opacity = Object(_easing__WEBPACK_IMPORTED_MODULE_1__["default"])(easing, parseFloat(fromOpacity), diff, time, duration);
  ...
  var slideAnimation = function slideAnimation(anim) {
    return new Promise(function (resolve, reject) {
      ...
      var id = setInterval(function () {
        time += 10;
        node.style.height = Object(_easing__WEBPACK_IMPORTED_MODULE_1__["default"])(easing, parseFloat(fromHeight), diff, time, duration) + 'px';
    ...
    return new Promise(function (resolve, reject) {
      ...
      var id = setInterval(function () {
        ...
        for (var _prop in params) {
          node.style[_prop] = Object(_easing__WEBPACK_IMPORTED_MODULE_1__["default"])(easing, parseFloat(fromProp[_prop]), diff[_prop], time, duration) + postfix[_prop];
        }

        if (time >= duration) {
          for (var _prop2 in params) {
            node.style[_prop2] = params[_prop2];
          }
...
var effects = function effects(kirinArr, curStyleProps) {
  ...
  var hideAnimation = function hideAnimation(name, option) {
    ...
    for (var _i3 = 0; _i3 < length; _i3++) {
      animations[_i3].genAnim({
        name: name,
        display: initDisplay[_i3],
        delay: delay,
        callback: callback
      });
    } // chaining을 위해
  ...
  var fadeAnimation = function fadeAnimation(name, option) {
    ...
    if (typeof option === 'function') {
      ...
      duration = Object(_utils_functions__WEBPACK_IMPORTED_MODULE_1__["getOwnOrInitProperty"])(option, 'duration', 1000);
      easing = Object(_utils_functions__WEBPACK_IMPORTED_MODULE_1__["getOwnOrInitProperty"])(option, 'easing', 'linear');
      to = Object(_utils_functions__WEBPACK_IMPORTED_MODULE_1__["getOwnOrInitProperty"])(option, 'to', 0);
    }

    for (var _i4 = 0; _i4 < length; _i4++) {
      animations[_i4].genAnim({
        name: name,
        display: initDisplay[_i4],
        duration: duration,
        easing: easing,
        to: to,
        callback: callback
  ...
  var slideAnimation = function slideAnimation(name, option) {
    ...
    for (var _i5 = 0; _i5 < length; _i5++) {
      animations[_i5].genAnim({
        name: name,
        display: initDisplay[_i5],
        height: initHeight[_i5],
        duration: duration,
        easing: easing,
        callback: callback
      });
...
var manipulation = function manipulation(kirinArr, curStyleProps, length) {
  /**
   * DONE:
   * @addClass
   * 
  ...
  var after = function after(content) {
  ...
  var append = function append(content) {
    var type = _typeof(content);
  ...
  var attr = function attr(attributeName) {
  ...
  var before = function before(content) {
    ...
    if (type === 'string') {
      ...
      try {
        for (var _iterator18 = kirinArr[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
          ...
          try {
            for (var _iterator19 = content[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
              var c = _step19.value;
  ...
  var css = function css(propertyName) {
    ...
    if (value === null) {
      ...
      if (_type === 'string' || _type === 'number') {
        ...
        for (var i = 0; i < length; i++) {
          var prop = curStyleProps[i][propertyName];
  ...
  var height = function height() {
    ...
    if (value === null) {
      ...
      if (type === 'number' || type === 'string') {
        ...
        if (!post) {
          ...
          try {
            for (var _iterator27 = kirinArr[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
              var _node13 = _step27.value;
              _node13.style.height = value;
            }
          } catch (err) {
        ...
        for (var i = 0; i < length; i++) {
          var _height = curStyleProps[i]['height'];
          kirinArr[i].style.height = parseFloat(func(i, _height)) + 'px';
        }
      }
    }
...
/* harmony import */ var _manipulation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manipulation */ "./src/js/manipulation.js");
...
var proto = function proto(kirinArr) {
  ...
  return _objectSpread({
    ...
    kirin: '1.0.0'
  }, Object(_events__WEBPACK_IMPORTED_MODULE_0__["default"])(kirinArr), Object(_effects__WEBPACK_IMPORTED_MODULE_1__["default"])(kirinArr, curStyleProps), Object(_manipulation__WEBPACK_IMPORTED_MODULE_2__["default"])(kirinArr, curStyleProps, length), Object(_traversing__WEBPACK_IMPORTED_MODULE_3__["default"])(kirinArr, curStyleProps));
};
...
var getStylePreAndPostFix = function getStylePreAndPostFix(prop) {
  var pre = prop;
  var post = '';
...
/***/ 0:
/*!***********************************************!*\
  !*** multi @babel/polyfill ./src/js/kirin.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/js/kirin.js */"./src/js/kirin.js");
